...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// Nested function can access the variable internal because it's written inside the brackets. We can pass the variable down, but not up. With closures, we have the ability to access functions form a parent level scope in child level scope.
...
//  const zoo = zooAnimals.filter(function (lowPopulationAnimals){
...
// console.log(zoo);
  ...
  */
  ...
  // function lowerCaseNames(array){
  //   const newArray = array.reduce(function(item){
  //     return item.animal_name.toLowerCase();
  //   })
  // return newArray;
  // }
...
function multiply(a,b){
  ...
  console.log(consume(7,5,multiply));
...
function greeting(a,b){
 ...
 console.log(consume("Kelley", "Hill", greeting));
...
class CuboidMakerTwo{
  constructor (plus){
    ...
    this.height = plus.height;
    this.width = plus.width;
  }
