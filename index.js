...
// Nested function can access the variable internal because it's written inside the brackets. We can pass the variable down, but not up. With closures, we have the ability to access functions forma  a parent level scope in child level scope.
...
const zooAnimals = [
 ...
 const titles = zooAnimals.map(function (lowerCaseNames){
...
console.log(zoo);
  ...
  */
  ...
  console.log(`${USApop} is the total population `)
...
let newCube = new CuboidMaker (4, 5, 5);
